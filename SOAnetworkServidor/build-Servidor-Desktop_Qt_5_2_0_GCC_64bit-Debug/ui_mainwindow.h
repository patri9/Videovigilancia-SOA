...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCaptura_de_Red = new QAction(MainWindow);
        ...
        menuCapt_Red = new QMenu(menuBar);
        menuCapt_Red->setObjectName(QStringLiteral("menuCapt_Red"));
        ...
        menuBar->addAction(menuCapt_Red->menuAction());
        ...
        menuCapt_Red->addAction(actionCaptura_de_Red);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionCaptura_de_Red->setText(QApplication::translate("MainWindow", "Captura de Red", 0));
        ...
        menuCapt_Red->setTitle(QApplication::translate("MainWindow", "Servidor", 0));
