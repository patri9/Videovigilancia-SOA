...
struct qt_meta_stringdata_Ayuda_t {
    QByteArrayData data[3];
    char stringdata[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Ayuda_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Ayuda_t qt_meta_stringdata_Ayuda = {
    {
QT_MOC_LITERAL(0, 0, 5),
QT_MOC_LITERAL(1, 6, 17),
QT_MOC_LITERAL(2, 24, 0)
    },
    "Ayuda\0on_Cerrar_clicked\0\0"
};
...
void Ayuda::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_Cerrar_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Ayuda::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Ayuda.data,
      qt_meta_data_Ayuda,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Ayuda.stringdata))
